//----------------------------------------------------------------
// <copyright file="KingYPositionConverter.cs" company="FH WN">
//     Copyright (c) Thomas Horvath. All rights reserved.
// </copyright>
// <summary>This file contains the KingYPositionConverter logic.</summary>
//-----------------------------------------------------------------------
namespace Chess.Converter
{
    ...
    /// <summary>
    /// The KingYPositionConverter class.
    /// </summary>
    public class KingYPositionConverter : IValueConverter
    {
        /// <summary>
        /// Converts a value to an integer value containing the Y coordinate of the king.
        /// </summary>
        ...
        /// <returns>Returns an integer value containing the Y coordinate of the king.</returns>
